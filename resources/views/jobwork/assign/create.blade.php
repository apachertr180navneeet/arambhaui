  ...
  <div style="display:flex; flex-direction:column; gap:20px;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:14px;">
      <div>
        ...
        <p style="margin:3px 0 0; font-size:0.85rem; color:var(--slate-500);">Outward dispatch order for Stitching, Fabric Cutting, Embroidery or Washing contractors.</p>
      </div>
    ...
    <div class="card" style="background:#fff; border-radius:var(--radius-xl); border:1px solid var(--slate-200); box-shadow:var(--shadow-sm); padding:24px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:18px;">
        ...
        <div class="form-group" style="margin-bottom:0;">
          ...
          <input type="text" name="lot_number" class="form-control" required placeholder="e.g. LOT-2026-088" style="font-family:var(--font-mono, monospace); font-weight:700;">
        </div>
        ...
        <div class="form-group" style="margin-bottom:0;">
          ...
          <input type="text" name="style_name" class="form-control" required placeholder="e.g. Men's Cotton Polo T-Shirt (Navy / M-L-XL)">
        </div>
    ...
    <div class="card" style="background:#fff; border-radius:var(--radius-xl); border:1px solid var(--slate-200); box-shadow:var(--shadow-sm); padding:24px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:18px;">
        ...
        <div class="form-group" style="margin-bottom:0;">
          ...
          <input type="number" step="1" min="0" name="issued_qty" id="ja_qty" class="form-control" required value="0" placeholder="0" oninput="calculateJWTotal()" style="font-weight:700; font-size:1.05rem;">
        </div>

        <div class="form-group" style="margin-bottom:0;">
          <label class="form-label" style="font-weight:700; color:var(--slate-800);">Contract Rate per Pc (₹) <span style="color:#ef4444;">*</span></label>
          <input type="number" step="0.5" min="0" name="rate_per_piece" id="ja_rate" class="form-control" required value="0.00" placeholder="0.00" oninput="calculateJWTotal()" style="font-weight:700;">
        </div>
      ...
      <div style="display:flex; justify-content:flex-end; margin-top:20px;">
        <div style="width:340px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; padding:18px; display:flex; flex-direction:column; gap:10px; font-size:0.875rem;">
          <div style="display:flex; justify-content:space-between;">
            ...
            <strong id="summary-pcs" style="color:var(--slate-900);">0 pcs</strong>
          </div>
          <div style="border-top:2px dashed #cbd5e1; padding-top:10px; display:flex; justify-content:space-between; font-size:1.1rem;">
            ...
            <span style="font-weight:800; color:#059669;" id="summary-total">₹0.00</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card" style="background:#fff; border-radius:var(--radius-xl); border:1px solid var(--slate-200); box-shadow:var(--shadow-sm); padding:24px;">
      ...
      <div class="form-group" style="margin-bottom:0;">
        <textarea name="instructions" class="form-control" rows="3" placeholder="Specify seam stitch density (SPI), thread color matching, shrinkage allowance, packaging and delivery requirements..."></textarea>
      </div>
    </div>
