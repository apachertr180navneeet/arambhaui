...
<div style="display:flex; flex-direction:column; gap:20px;">
  ...
  <div style="background:#ffffff; border-radius:var(--radius-xl); border:1px solid var(--slate-200); padding:16px 20px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; box-shadow:var(--shadow-sm);">
    ...
    <div style="display:flex; gap:8px;">
      <button class="btn btn-secondary btn-sm" onclick="UI.printElement('ledger-table', 'Item Stock Movement Ledger - ' + {!! json_encode($companyName ?? 'GarmentERP') !!})" style="display:inline-flex; align-items:center; gap:6px;">
      ...
      <button class="btn btn-secondary btn-sm" onclick="UI.exportTableToCSV('ledger-table', '{{ Str::slug($companyName ?? 'company') }}_Stock_Ledger.csv')">
        Export CSV
      </button>
    </div>
  </div>
