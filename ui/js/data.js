...
const INITIAL_DATA = {
  ...
  purchaseOrders: [
    {
      id: "PO-2026-0812",
      vendor: "Shree Fabrics",
      vendorId: "VND-001",
      poDate: "2026-08-06",
      expectedDate: "2026-08-14",
      warehouse: "Main Raw Material Store - Unit 1",
      items: [
        { item: "100% Combed Cotton Fabric 180 GSM", code: "FAB-COT-180", qty: 5000, unit: "Meters", rate: 145, tax: 5, amount: 761250 }
      ],
      subtotal: 725000,
      taxTotal: 36250,
      grandTotal: 761250,
    ...
    {
      id: "PO-2026-0815",
      vendor: "ABC Textile Supplier",
      vendorId: "VND-002",
      poDate: "2026-08-10",
      expectedDate: "2026-08-18",
      warehouse: "Main Raw Material Store - Unit 1",
      items: [
        { item: "Heavy Indigo Denim Fabric 12 Oz", code: "FAB-DEN-12OZ", qty: 4000, unit: "Meters", rate: 220, tax: 5, amount: 924000 }
      ],
      subtotal: 880000,
      taxTotal: 44000,
      grandTotal: 924000,
    ...
    {
      id: "PO-2026-0818",
      vendor: "Modern Accessories",
      vendorId: "VND-004",
      poDate: "2026-08-12",
      expectedDate: "2026-08-19",
      warehouse: "Main Raw Material Store - Unit 1",
      items: [
        { item: "YKK Brass Metal Zipper #5", code: "ACC-ZIP-YKK5", qty: 3000, unit: "Pieces", rate: 18, tax: 18, amount: 63720 },
        { item: "Polyester Pearl Buttons 18L", code: "ACC-BTN-18L", qty: 400, unit: "Gross", rate: 45, tax: 18, amount: 21240 }
      ],
      subtotal: 72000,
      taxTotal: 12960,
      grandTotal: 84960,
  ...
  // 8. Purchase Inwards (Goods Receipt Notes / GRN)
  purchaseInwards: [
    {
      id: "GRN-2026-0410",
      ...
      rejectedQty: 0,
      acceptedQty: 5000,
      lotNumber: "RAW-LOT-COT-8812",
      inspectedBy: "Ramesh Thorat",
      status: "Approved"
    }
  ],
